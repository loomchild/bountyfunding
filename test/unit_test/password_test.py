...
def test_password_setter():
    account = Account("jane@bountyfunding.org", 'cat')
...
def test_password_salts_are_random():
    account1 = Account("jane@bountyfunding.org", 'cat')
    account2 = Account("john@bountyfunding.org", 'cat')
    assert account1.password_hash != account2.password_hash

def test_empty_password():
    account = Account("jane@bountyfunding.org", None)
